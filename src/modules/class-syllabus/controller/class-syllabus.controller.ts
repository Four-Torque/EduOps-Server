...
export class ClassSyllabusController {
  ...
  @ApiSuccessResponse(
    ResponseMessage.CLASS_SYLLABUS_CREATED,
    ClassSyllabusResponse,
  )
  ...
  async create(
    ...
    return await this.classSyllabusService.create(user.id, request);
  }
  ...
  @ApiSuccessResponse(
    ResponseMessage.CLASS_SYLLABUS_FETCHED,
    PaginatedClassSyllabusResponse,
  )
  @ApiErrorResponse(ErrorCode.INTERNAL_SERVER_ERROR)
  @Message(ResponseMessage.CLASS_SYLLABUS_FETCHED)
  ...
  @ApiSuccessResponse(
    ResponseMessage.CLASS_SYLLABUS_APPROVED,
    ClassSyllabusResponse,
  )
  @ApiErrorResponse(
  ...
  @ApiSuccessResponse(
    ResponseMessage.CLASS_SYLLABUS_REJECTED,
    ClassSyllabusResponse,
  )
  @ApiErrorResponse(
    ErrorCode.CLASS_SYLLABUS_NOT_FOUND,
